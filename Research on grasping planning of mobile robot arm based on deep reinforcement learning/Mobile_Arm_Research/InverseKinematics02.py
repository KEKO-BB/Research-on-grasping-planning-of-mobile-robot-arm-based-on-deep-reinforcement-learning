...
class InverseKinematics_planning():
    def __init__(self,L1, L2, L3, L4, base_height, offset_z, joint2_range, joint3_range, joint4_range, Connectioner) -> None:
        self.L1 = L1
        self.L2 = L2
        self.L3 = L3
        self.L4 = L4
    ...
    def calculate_inverse_kinematics(self):
        ...
        # 使用minimize函数进行优化
        result = minimize(self.objective_function, initial_guess, args=(target_position,), bounds=bounds, method='SLSQP',options=options)
...
if __name__ == "__main__":
    ...
    InverseKinematics_planning = InverseKinematics_planning(L1=0.01351793110370636, L2=0.10496972501277924, L3=0.09500536322593689, L4=0.172,
