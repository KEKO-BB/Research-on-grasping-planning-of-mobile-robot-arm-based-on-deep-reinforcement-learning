...
class Mobile_Arm_Env(gym.Env):
    ...
    def __init__(self, action_type='continuous') -> None:
        ...
        ######################################
        self.last_robot_state = np.zeros(31)  #

        self.end_to_target_shortdis = 0  # 判断可抓取的最小距离
        ...
        self.observation_space = spaces.Box(low=self.low, high=self.high, shape=(31,), dtype=np.float32)
    ...
    def get_current_state(self):
        ...
        #### 测试 #############################################
        # self.end_path.append(end_target)
        #######################################################
    ...
    def step(self, action):
        ...
        # 停止条件
        # 车身已经超过目标点
        if arm_end[0] - self.target_current_position[0] > 0.2 :
            done = True
    ...
    def reset_simple(self):
        ...
        self.Connectioner.robot_model.Target_random_sample()  # 目标位置随机产生一次
        # self.Connectioner.robot_model.Obstacle_random_3()  # 障碍物随机位置一次
