...
class TD3:
    def __init__(self, n_states, n_actions, cfg) -> None:
        ...
        self.cfg = cfg
        self.device = torch.device(cfg.device)
        self.critic1 = Critic(n_states, n_actions, cfg.hidden_dim, cfg.lstm_dim, cfg.lstm_layers,
                             cfg.time_step_features).to(self.device)
        self.critic2 = Critic(n_states, n_actions, cfg.hidden_dim, cfg.lstm_dim, cfg.lstm_layers,
                             cfg.time_step_features).to(self.device)
        self.actor = Actor(n_states, n_actions, cfg.hidden_dim, cfg.lstm_dim, cfg.lstm_layers,
                           cfg.time_step_features).to(self.device)
        self.target_critic1 = Critic(n_states, n_actions, cfg.hidden_dim, cfg.lstm_dim, cfg.lstm_layers,
                                     cfg.time_step_features).to(self.device)
        self.target_critic2 = Critic(n_states, n_actions, cfg.hidden_dim, cfg.lstm_dim, cfg.lstm_layers,
                                     cfg.time_step_features).to(self.device)
