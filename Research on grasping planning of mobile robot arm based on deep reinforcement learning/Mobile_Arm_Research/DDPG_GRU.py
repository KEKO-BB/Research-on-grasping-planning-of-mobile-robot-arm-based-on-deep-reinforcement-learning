...
class DDPG:
    def __init__(self, n_states, n_actions, cfg) -> None:
        ...
        self.cfg = cfg
        self.device = torch.device(cfg.device)
        self.critic = Critic(n_states, n_actions, cfg.hidden_dim, cfg.gru_dim, cfg.gru_layers,
                             cfg.time_step_features).to(self.device)
        self.actor = Actor(n_states, n_actions, cfg.hidden_dim, cfg.gru_dim, cfg.gru_layers,
                           cfg.time_step_features).to(self.device)
        self.target_critic = Critic(n_states, n_actions, cfg.hidden_dim, cfg.gru_dim, cfg.gru_layers,
                                    cfg.time_step_features).to(self.device)
